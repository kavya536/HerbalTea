        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
                ...
                >
                  ...
                  <div className="relative w-full h-[280px] mb-2 flex items-center justify-center rounded-t-3xl pt-2 px-1">
                    <img 
                      src={product.img} 
                      alt={product.name} 
                      className={`w-full h-full object-contain drop-shadow-sm transition-transform duration-700 ease-in-out ${product.img.endsWith('/blue.png') ? 'scale-[1.4] translate-y-1' : ''}`} 
                    />
                  </div>
          ...
          <div className="w-full lg:w-1/4 order-1 lg:order-2 flex flex-col gap-10 sticky top-28">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <Leaf className="w-5 h-5 text-[#2c4a35] fill-[#2c4a35]" />
                <h3 className="font-semibold text-[#1c2e24] text-[16px]" style={{ fontFamily: 'Playfair Display, serif' }}>Benefits</h3>
              </div>
              <div className="flex flex-col gap-3">
                 {BENEFITS.map(ben => (
                   <label key={ben} className="flex items-center gap-3 cursor-pointer group">
                     ...
                     <span className={`text-[14px] transition-colors ${selectedBenefit === ben ? 'text-[#1c2e24] font-medium' : 'text-[#6b7b72] group-hover:text-[#1c2e24]'}`} style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
                       {ben}
                     </span>
                   </label>
                 ))}
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <Leaf className="w-5 h-5 text-[#2c4a35] fill-[#2c4a35]" />
                <h3 className="font-semibold text-[#1c2e24] text-[16px]" style={{ fontFamily: 'Playfair Display, serif' }}>Ingredients</h3>
              </div>
              <div className="flex flex-col gap-3">
                 {INGREDIENTS.map(ing => (
                   <label key={ing} className="flex items-center gap-3 cursor-pointer group">
                     ...
                     <span className={`text-[14px] transition-colors ${selectedIngredient === ing ? 'text-[#1c2e24] font-medium' : 'text-[#6b7b72] group-hover:text-[#1c2e24]'}`} style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
                       {ing}
                     </span>
                   </label>
                 ))}
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <Leaf className="w-5 h-5 text-[#2c4a35] fill-[#2c4a35]" />
                <h3 className="font-semibold text-[#1c2e24] text-[16px]" style={{ fontFamily: 'Playfair Display, serif' }}>Category</h3>
              </div>
              <div className="flex flex-col gap-3">
                 {CATEGORIES.map(cat => (
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <Leaf className="w-5 h-5 text-[#2c4a35] fill-[#2c4a35]" />
                <h3 className="font-semibold text-[#1c2e24] text-[16px]" style={{ fontFamily: 'Playfair Display, serif' }}>Rating</h3>
              </div>
              <div className="flex flex-col gap-3">
                 {RATINGS.map(rate => (
                   <label key={rate} className="flex items-center gap-3 cursor-pointer group">
                     ...
                     <span className={`text-[14px] transition-colors flex items-center gap-1 ${selectedRating === rate ? 'text-[#1c2e24] font-medium' : 'text-[#6b7b72] group-hover:text-[#1c2e24]'}`} style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
