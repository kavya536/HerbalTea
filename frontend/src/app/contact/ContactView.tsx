    ...
    <div className="flex flex-col w-full min-h-[calc(100vh-80px)] bg-[#f5f0e6]">
      ...
      <section className="relative w-full min-h-[350px] md:min-h-[420px] flex items-center bg-[#f2f4ed] overflow-hidden mb-12 md:mb-16">
        ...
        <div 
          ...
          style={{ background: 'linear-gradient(to right, rgba(198,200,190,0.9) 0%, rgba(198,200,190,0.8) 20%, rgba(140,143,129,0.6) 35%, transparent 55%)' }}
        ></div>
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-12 flex flex-col justify-center">
          <div className="w-full md:w-[55%] lg:w-[45%] flex flex-col items-start text-[#0F3D2E]">
            <h1 className="text-[42px] md:text-[56px] lg:text-[72px] font-bold leading-[1.1] mb-6 tracking-tight" style={{ fontFamily: 'Playfair Display, serif' }}>
              Wellness Contact
            </h1>
      ...
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 w-full relative">
        ...
        <div className="mt-8 mb-8 w-full">
          <h2 className="text-[28px] md:text-[32px] font-semibold text-[#1c2e24] mb-10 uppercase tracking-wide text-center" style={{ fontFamily: 'Playfair Display, serif' }}>
            CONTACT INFORMATION
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-[14px] text-[#1c2e24] font-medium" style={{ fontFamily: 'Nunito Sans, sans-serif' }}>rherbaltea@gmail.com</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-7 h-7 rounded-full bg-[#d6bc8b] flex items-center justify-center shrink-0">
                    <Phone className="w-3.5 h-3.5 text-[#1c2e24]" />
                  </div>
                  <p className="text-[14px] text-[#1c2e24] font-medium" style={{ fontFamily: 'Nunito Sans, sans-serif' }}>+91 7799733755</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[14px] text-[#1c2e24] font-medium leading-[1.6]" style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
                    Head Office<br />
          ...
          >
            ...
            {isSubmitted ? (
              ...
              >
                ...
                <p className="text-[15px] text-[#4a554e] leading-relaxed max-w-[300px]" style={{ fontFamily: 'Nunito Sans, sans-serif' }}>
      ...
      <section className="w-full bg-[#fcfbf9] py-16 md:py-20">
        <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <h2 className="text-[28px] md:text-[32px] font-semibold text-[#1c2e24] mb-8 text-center" style={{ fontFamily: 'Playfair Display, serif' }}>
            Google Map
          </h2>
          <motion.div 
